<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="schedulePickup.aspx.cs" Inherits="schedulePickup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="padding-top:50px;">
    	<div class="container">
            <asp:Label ID="lable_msg" runat="server" class="alert alert-success" Visible="false" style="padding-bottom:20px">Add a Blog</asp:Label>
...
<%--                  <div class="panel panel-default">
    			...
    			<div class="col-md-7 right-contact bg-grey">
                    
    				<h4 style="padding-top:15px"> Schedule a Free Pick Up</h4>
    				<div class="form-inline form-contact-finance form-contact-2" name="contact">
                  <div class="row">                 
               
                    <div class="form-group col-sm-6">
                        
                        <asp:DropDownList runat="server" ID="services" DataValueField="id" DataTextField="title" class="form-control" style="width: 100%;height: 50px"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="services" ErrorMessage="*Required"></asp:RequiredFieldValidator>                      
                    </div>
                
                     <div class="form-group col-sm-6">
                                
                               <asp:DropDownList runat="server" ID="states" DataValueField="id" DataTextField="name" class="form-control" AutoPostBack="true"  style="width: 100%;height: 50px" OnSelectedIndexChanged="states_SelectedIndexChanged"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="states" ErrorMessage="*Required"></asp:RequiredFieldValidator>                      
                            </div>
                
                     <div class="form-group col-sm-6">
                                
                                <asp:DropDownList runat="server" ID="selectCity" DataValueField="id" DataTextField="name" class="form-control" style="width: 100%;height: 50px"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="selectCity" ErrorMessage="*Required"></asp:RequiredFieldValidator>                      
                            </div>
                      <div class="form-group col-sm-6">
                                    <asp:TextBox runat="server" placeholder="Address *" id="street_address" class="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="street_address" ErrorMessage="*Required"></asp:RequiredFieldValidator>  
                                    
                                </div>
                                <div class="form-group col-sm-6">
                                    <asp:TextBox runat="server" placeholder="Postcode/ZIP *" id="postcode" class="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="postcode" ErrorMessage="*Required"></asp:RequiredFieldValidator>  
                  ...
                  <asp:Button runat="server" class="ot-btn large-btn btn-rounded btn-main-color btn-submit" Text="Schedule" id="button_submit" Onclick="button_submit_Click"></asp:Button>
                 </div> <!-- End Form -->
    			</div> <!-- End col -->
    		</div>
    	</div>

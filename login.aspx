            ...
            <section class="shopping-cart">
                ...
                <asp:Button ID="btnTest" runat="server" Text="X" OnClick="btnTest_Click" />
                        ...
                        <div class="col-sm-12 col-md-12">
                            ...
                            <h3 class="text-cap padding-top-45">Login into Your Account </h3>                            
                            <div class="checkout shop-checkout">
                               <p class="form-row form-row-wide">
                                ...
                                <p class="form-row form-row-wide">
                                    <asp:TextBox runat="server" placeholder="Password *" id="textPassword" class="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="textPassword" ErrorMessage="*Required"></asp:RequiredFieldValidator>  
                                    
                                </p>
                                
                               
                            </div>
                            <div class="form-row form-row-first" style="padding-top: 0px">
                            <asp:Button runat="server" class="ot-btn large-btn btn-rounded btn-main-color btn-submit" Text="Login" id="button_submit" Onclick="submit_button_Click"></asp:Button>
                                
                                </div>
                           
                                                            <div class="">
                                                                <p class="form-row form-row-first ">
                                      <a class="showlogin float-right" href="http://localhost:54977/Register">Click here to Register</a>                 
                                    </p>
                                   
                                    <p class="form-row form-row-last text-right" style="text-align:right;">
                                       <a class="showlogin float-right" href="http://localhost:54977/Forget-Password">Forgot Password</a>
                                    </p>
                                </div>
                        </div>
                      </div>

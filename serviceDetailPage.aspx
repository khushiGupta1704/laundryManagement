<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="serviceDetailPage.aspx.cs" Inherits="serviceDetailPage" %>
            ...
            <div class="col-md-3 slidebar">
                <div class="list-group">
                    ...
                    <asp:Repeater runat="server" ID="Repeater2">
                                            <ItemTemplate>
                           <a href="serviceDetailPage.aspx?id=<%#Eval("id")%>" class="list-group-item"><%#Eval("title")%></a>
                     </ItemTemplate>
                 ...
                 <div class="list-group">
                    ...
                    <asp:Repeater runat="server" ID="Repeater1">
                                            <ItemTemplate>
                           <a href="blogDetail.aspx?id=<%#Eval("id")%>" class="list-group-item"><%#Eval("title")%></a>
                     </ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageInd.master" AutoEventWireup="true" CodeFile="setting.aspx.cs" Inherits="setting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <asp:Label ID="title_msg" runat="server" class="card-title"><h4>Setting</h4></asp:Label>
                ...
                <div class="forms-sample">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" class="form-control" ID="inputName" placeholder="Company Name"></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-xs-12">
                                    <asp:FileUpload ID="industryImage" runat="server" type="text" class="form-control file-upload-info" placeholder="Upload Image"></asp:FileUpload>
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" class="form-control" ID="altPhoneNo" placeholder="Phone No"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">                       
                    ...
                    <asp:Button ID="submit_button" runat="server" class="btn btn-primary mr-2" Text="Submit" OnClick="submit_button_Click" />
